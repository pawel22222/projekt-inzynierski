  ...
  return (
    <AuthWrapper>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <FormGroup id='password' label='Hasło' type='password' required={true} ref={passwordRef} />
        <ButtonSubmit label='Zaloguj się' type='submit' loading={loading} />
        {loading && <SpinnerLoading />}
      </Form>
      <AuthHelperWrapper>
        <div>
          Nie masz konta? <NavLink to='/signup'>Rejestracja</NavLink>
        </div>
        <div>
          Zapomniałeś hasła? <NavLink to='/forgot-password'>Zmień hasło</NavLink>
        </div>
      </AuthHelperWrapper>
    </AuthWrapper>
  );
